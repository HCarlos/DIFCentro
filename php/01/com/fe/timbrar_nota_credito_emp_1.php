...
$ef = mysql_query("select rfc,razon_social,calle, num_ext, num_int,colonia,localidad,estado,cp,pais from _viEmiFis where idemisorfiscal = $ef[0] and idemp = $idemp and status_emisor_fiscal = 1");
...
foreach ($xml->xpath('//t:TimbreFiscalDigital') as $tfd) {
	...
	if ($folfis!=""){
		...
		$result = mysql_query("update facturas_encabezado set isfe = 1, UUID = '$folfis', xml = '$fxml', pdf='$fpdf', serie = '$serie', folio = $folio, fecha_timbrado = NOW(), directorio = '$directorio' where idfactura = $idfactura");
